...
| Dora 移动端新 UX 原型 | 移动端 Dora、专家团、资料库与会话文件链路原型 | `dora-mobile-newux/prototype.html` |
...
```
uxdemo/
├── AGENTS.md                        # AI Agent 执行规则（本目录生效）
├── index.html                       # 原型导航主页
├── workflow-explainer.html          # 工作流说明页
...
4. **同步更新 `README.md`**，补充原型列表或目录结构
5. 推送到 GitHub

AI 修改规则见 `AGENTS.md`，完整工作流说明见 `CLAUDE.md`。
